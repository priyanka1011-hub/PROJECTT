        ...
        $.ajax({
            ...
            success : function(mybrandlist){
                $.each(mybrandlist, function(i, mybrand){
                    $mybrandlist.append('<div class="col-sm-2 brand">' + '<div class="card card-body">' + '<div class="picture">' + '<a target="_blank" href=' + mybrand.product_link  + '>'+'<img width="185px" height="180px"src=' + mybrand.image_link + '>' + '</a>' + '</div>' + '<div>' +'<h2 class="contents">' + mybrand.name + '</h2>' +'</div>'+ '<h2 class="contents-brand">' + mybrand.brand + '</h2>' + '<h2 class="contents-brand">' + mybrand.price + mybrand.currency + '</h2>'  + '</div>' + '</div>')
                });
            }
        });
    });
...
$(function(){
    $("#alva").click(function(){
        ...
        $.ajax({
            ...
            success : function(mybrandlist){
                $.each(mybrandlist, function(i, mybrand){
                    $mybrandlist.append('<div class="col-sm-2 brand">' + '<div class="card card-body">' + '<div class="picture">' + '<a target="_blank" href=' + mybrand.product_link  + '>'+'<img width="185px" height="180px"src=' + mybrand.image_link + '>' + '</a>' + '</div>' + '<div>' +'<h2 class="contents">' + mybrand.name + '</h2>' +'</div>'+ '<h2 class="contents-brand">' + mybrand.brand + '</h2>' + '<h2 class="contents-brand">' + mybrand.price + mybrand.price_sign + '</h2>'  + '</div>' + '</div>')
                });
            }
        });
    });
